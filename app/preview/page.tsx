...
import { FaArrowRight, FaLinkedin, FaShareAlt, FaYoutube } from 'react-icons/fa';
    ...
    return (
        <div className='w-full h-screen'>
            ...
            <div className='bg-indigo-700 w-full h-2/6 rounded-b-[40px] pt-5'>
                <div className='flex justify-between bg-white px-5 py-3 w-11/12 mx-auto rounded-lg'>
                    <Link
                        href={"/links"}
                        className='border-2 border-indigo-700 px-5 py-3 rounded-lg text-indigo-700 font-semibold hover:bg-indigo-100'
                    >
                    ...
                    <button
                        className='border-2 bg-indigo-700 px-5 py-3 rounded-lg text-white font-semibold hover:bg-indigo-900'
                    >
